...
class EnsemblPipeline(object):
    ...
    def process_item(self, item, spider):
        line = [item['rsid'], item['risk_allele'],item['r_cdx'],item['rr_cdx'],item['nn_cdx'],item['rn_cdx'],item['r_chb'],item['rr_chb'],item['nn_chb'],item['rn_chb'],item['r_chs'],item['rr_chs'],item['nn_chs'],item['rn_chs'],item['r_eas'],item['rr_eas'],item['nn_eas'],item['rn_eas'] ]
        self.ws.append(line)
        return item
